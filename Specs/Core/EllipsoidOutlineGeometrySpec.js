...
describe("Core/EllipsoidOutlineGeometry", function () {
  ...
  it("computes positions", function () {
    var m = EllipsoidOutlineGeometry.createGeometry(
  ...
  it("undefined is returned if the x, y, or z radii are equal or less than zero", function () {
    ...
    var geometry10 = EllipsoidOutlineGeometry.createGeometry(
      ellipsoidOutline10
    );
    var geometry11 = EllipsoidOutlineGeometry.createGeometry(
      ellipsoidOutline11
    );
